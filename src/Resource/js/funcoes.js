...
const URL_API = window.PATH_URL = document.location.origin + '/api_gestao/src/Resource/api/';
const URL_IMG =  window.PATH_URL = document.location.origin + '/api_gestao/src/Resource/';
