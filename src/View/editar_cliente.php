						...
						<div class="row">
							...
							<div class="col-lg-2 col-sm-2 col-12">
								<div class="form-group" data-select2-id="8">
									<label>CTipo</label>
									<select id="CliTipo" class="select select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true">
										<option data-select2-id="1">Cliente</option>
										<option data-select2-id="2">Fornecedor</option>
									</select>
								</div>
							</div>
